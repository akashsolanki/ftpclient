 ...
 * @since 3.1
 */
public final class CustomADAuthenticator extends
	 ...
	 */
	public CustomADAuthenticator(String domain, String url,
			String rootDn) {
	...
	class ActiveDirectoryAuthenticationException extends org.springframework.security.core.AuthenticationException {
